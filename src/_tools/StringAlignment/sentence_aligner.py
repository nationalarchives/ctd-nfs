...
class SentenceAligner:
    ...
    def border_align(self, text_a: str, text_b: str) -> dict:
        """_summary_

        Args:
            text_a (str): _description_
            text_b (str): _description_

        Returns:
            dict: _description_
        """        
        align_a = f"^{text_a.lower()}$"
        align_b = f"^{text_b.lower()}$"
        ...
        word_boundaries = [
            (a[0], a[1], i, " ") 
            if a[1] is not None and align_b[a[1]] == " " else (a[0], a[1], i, None) 
            for i, a in enumerate(AL) 
            if a[0] is not None and align_a[a[0]] == " "
        ]
        x = 1
        y = 1
    ...
    def multi_align(self, *alignment_data: tuple) -> dict:
        """_summary_
...
if __name__ == '__main__':
    ...
    #SA.border_align("apple pear banana", "apple pear banana")
    #SA.border_align("apple par banana", "apple pear banana")
    ##SA.border_align("i apple par banana", "apple pear banana")
    #SA.border_align("apple par banana", "i apple pear banana")
    #SA.border_align("apple par banana", "apple i pear banana")
    #SA.border_align("apple par banana", "apple pear banana i")
    #SA.border_align("i apple pear banana", "i applepear banana")
    #SA.border_align("i applepear banana", "i apple pear banana")
    #SA.border_align("and estates here after limitted from being defeated or", "and estates hereinafter limited from being defeated or")
    A1 = SA.border_align("and estates hereinafter limitted from being defeated or", "and estates here after limited from being defeated or")
    A2 = SA.border_align("and estates hereinafter limitted from being defeated or", "and estates here after limited from being defeated or")
    A3 = SA.border_align("and estates hereinafter limitted from being defeated or", "and estates here after limi ted from being defeated or")
