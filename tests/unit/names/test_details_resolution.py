...
def test_single_person_with_full_details():
    ...
    full_address = resolve_single_name_and_address(title, name, address)
...
def test_full_details_for_two_people():
    ...
    full_address = resolve_multiple_details(titles, names, addresses)
...
def test_full_details_for_two_people_with_missing_address():
    ...
    full_address = resolve_multiple_details(titles, name, address)
...
def test_title_and_name_both_specified():
    ...
    full_address = resolve_single_title_and_name(title, name)
...
def test_full_details_for_multiple_people():
    ...
    assert full_address == \
        "Sherlock Holmes, Esq., 221B Baker Street; " \
        "Dr John Watson, 222B Baker Street; " \
        "Insp Baynes, Surrey Constabulary, Guildford; " \
        "Prof James Moriarty, London"
