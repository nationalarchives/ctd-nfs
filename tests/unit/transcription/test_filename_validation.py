...
def test_values_between_filenames_different_pieces(transcription):
...
def test_values_between_filenames_different_parish_numbers(transcription):
	transcription.update({
...
def test_values_between_filenames_image_number_error(transcription):
	transcription.update({
...
def test_values_between_filenames_parish_number_mismatch(transcription):
	transcription.update({
...
def test_not_consecutive_images(transcription):
	transcription.update({
		'filename_1': "MAF32-167-28_386.tif",
