...
def farms():
	values = [
		[
			...
			"H R Fleming",
			"*",
			"Rayrigg Hall, Windermere, Westmorland",
			"*",
			"R Nicholson",
			"*",
			"The Grove Farm, Ambleside",
			"162.5/886.5/1049",
			"26 NE",
			"06-Feb-42",
			"12-Feb-43",
		...
		[
			...
			"W Parsons",
			"*",
			"Gale House, Ambleside, Westmorland",
			"",
			"",
			"\"R T E Conant, Agents Smith and Co; The Crown, Carter Jonas and Sons; Rev Barston\"",
			"",
			"",
			"",
			"",
		...
		[
			...
			"*",
			"*",
			"Mr Kellett; Mr Swift; Mr W Bain; Mrs Mane; Mrs Todd; W Walton",
			"8 Sendal, Yorkshire; Barnard Castle; Darlington Road, Barnard Castle; Gallowgate, Barnard Castle; Gallowgate, Barnard Castle; 24 Coronation Road, Redcar",
			"*",
			"W J Chaplow",
			"*",
			"Barnard Castle",
		...
		[
			...
			"*",
			"*",
			"Nichols, Agent for the Earl of Ancaster",
			"Hambleton, Oakham",
			"*",
			"*",
			"Woodhead Bros",
			"Hambleton, Oakham",
			"Arable 127.5; Grass 45; 172.5",
			"9 NE1931 Edition",
			"30 January 1942",
			"*",
		]
