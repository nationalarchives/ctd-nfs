...
def farms():
    return (
        {'filename_1': 'MAF32-194-1_59.tif', 'filename_2': 'MAF32-194-1_60.tif', 'document_type': 'B496/EI', 'county': 'WD Westmorland', 'parish': '1 Ambleside', 'primary_farm_number': '18', 'additional_farms': 'Outhouse, No 1', 'farm_name': 'The Grove Farm', 'addressee_title': '', 'addressee_individual_name': '', 'addressee_group_names': '', 'address': '', 'owner_title': 'Rev', 'owner_individual_name': 'H R Fleming', 'owner_group_names': '*', 'owner_address': 'Rayrigg Hall, Windermere, Westmorland', 'farmer_title': '*', 'farmer_individual_name': 'R Nicholson', 'farmer_group_names': '*', 'farmer_address': 'The Grove Farm, Ambleside', 'acreage': '162.5/886.5/1049', 'OS_map_sheet': '26 NE', 'field_info_date': '06-Feb-42', 'primary_record_date': '12-Feb-43', '': ''},
        {'filename_1': 'MAF32-194-1_75.tif', 'filename_2': 'MAF32-194-1_76.tif', 'document_type': 'C 47/SSY', 'county': 'WD Westmorland', 'parish': '1 Ambleside', 'primary_farm_number': '19', 'additional_farms': '', 'farm_name': '', 'addressee_title': 'Mr', 'addressee_individual_name': 'W Parsons', 'addressee_group_names': '*', 'address': 'Gale House, Ambleside, Westmorland', 'owner_title': '', 'owner_individual_name': '', 'owner_group_names': '"R T E Conant, Agents Smith and Co; The Crown, Carter Jonas and Sons; Rev Barston"', 'owner_address': '', 'farmer_title': '', 'farmer_individual_name': '', 'farmer_group_names': '', 'farmer_address': '', 'acreage': '', 'OS_map_sheet': '', 'field_info_date': '', 'primary_record_date': '', '': ''},
